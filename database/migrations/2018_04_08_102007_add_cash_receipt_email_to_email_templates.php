...
class AddCashReceiptEmailToEmailTemplates extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $file = base_path($seedsemailpath . 'cash_receipt_new.txt');
        ...
        $datainsert['relation'] = 'cash_receipt|new';
        $datainsert['available_variables'] = $var_default . '|' . $var_application . '|' . $var_profile . '|' . $var_cash_receipt;
        $datainsert['subject'] = '{{customer_entity}}, here is your cash receipt {{cash_receipt_no}}';
