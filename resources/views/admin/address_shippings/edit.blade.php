<div class="modalhide">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">{{ trans('app.edit_address') }}
            : {{ $address->friendly_name }}<br><small>{{ $profile->business_name }}</small></h4></h4>
    </div>
    <form role="form" method="POST" action="{{ url(Session::get('guard') . '/profiles/'.$profile->id.'/address_shippings') }}/{{ $address->id }}"
          id="idForm" reloadiv="{{ Request::segment(7) }}"
          reloadurl="{{ url(Session::get('guard') . '/profiles/'.$profile->id.'/address_shippings') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="100" name="state" value="{{ $address->state }}"
                               class="form-control">
                    </div>
                </div>
            </div>
