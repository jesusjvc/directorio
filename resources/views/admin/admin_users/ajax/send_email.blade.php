    <form role="form" method="POST" action="{{ url(Session::get('guard') . '/users/' . $user->id . '/send_mail') }}" id="idForm"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="email_body"
                                              rows="18">
{{ trans('app.dear_user_names',["user_names" => ucwords(trans('app.' . $user->prefix) . ' ' . $user->firstname . ' ' . $user->lastname . ',')]) }}
</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div>
                                    <pre class="variableblock">@foreach($vars as $usable)<span
                                                class="badge badge-info lowercase nobold">&#123;&#123;{{ $usable }}&#125;&#125;</span> @endforeach </pre>
                                </div>
                            </div>
                        </div>
                        <div class="row">
