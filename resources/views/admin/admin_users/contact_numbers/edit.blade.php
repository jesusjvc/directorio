<div class="modalhide">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">{{ trans('app.edit_contact_number') }}
            ...
            <br>
            <small>{{ ucwords($contact_number->user->prefix . ' ' . $contact_number->user->firstname . ' ' . $contact_number->user->lastname) }}</small>
        </h4>
    </div>
    <form role="form" method="POST" action="{{ url(Session::get('guard') . '/user_contact_numbers/' . $contact_number->id) }}" id="idForm"
          reloadurl="{{ url(Session::get('guard') . '/users') }}">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="number_type" id="number_type" required>
