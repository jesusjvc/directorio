<div class="modalhide">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">{{ trans('app.edit_administrator_user_account') }}<br>
            <small>{{ ucwords(trans('app.' . $user->prefix)) }} {{ $user->firstname }} {{ $user->lastname }}</small></h4>
    </div>
    <form role="form" method="POST" action="{{ url(Session::get('guard') . '/users/'.$user->id) }}" id="idForm"
