                ...
                <div class="panel panel-default">
                        ...
                        <div class="pull-right">
                            ...
                            @if($profile->accountbalance > 0)
                                <button class="btn btn-xs btn-primary" data-toggle="modal" data-target="#ajaxmodel"
                                        data-remote="{{ url(Session::get('guard') . '/' . $profile->id . '/airtime/buy') }}">
                                    {{ trans('app.buy_airtime_on_behalf_of_profile', ["profile"    =>   $profile->business_name]) }}
                                </button>
                            @endif
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="collapse" id="collapse">
                            <div class="text-muted">{!! trans('descriptions.airtime_explained') !!}</div>
                            <hr>
                        </div>
                                            ...
                                            <td>
                                                @if($transaction->invoice != null)
                                                    <a class="btn btn-default btn-xs"
                                                       href="{{ url(Session::get('guard') . '/invoices/' . $transaction->invoice->id . '/preview') }}"
