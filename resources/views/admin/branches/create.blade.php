@extends(Session::get('guard') . '.layouts.app') @section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <form role="form" method="POST" action="{{ url(Session::get('guard') . '/' . $profile->id . '/branches') }}">
                {{ csrf_field() }}
...
//                            });
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="50" name="branch_name"
                                       class="form-control"
                                       required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        @foreach($businesshours as $instance)
                            <div class="col-lg-3 col-md-6 col-xs-12">
                                <label class="m-t-15">{{ trans('app.' . strtolower($instance)) }}</label>
                                <div class="input-group {{ $instance }}" data-placement="bottom" data-align="top"
                                     data-autoclose="true">
                                    <input type="text" class="form-control" value="12:00"
                                           name="business_hours[{{ $instance }}]">
                    ...
                    <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="tags-default">
                                    <input type="text" name="facilities" data-role="tagsinput" placeholder="{{ trans('app.eg_coffee_aircon') }}"/>
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" maxlength="100" name="search" id="myPlaceTextBox"
                                       class="form-control"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('app.latitude') }} <span
                                            class="required"> * </span></label>
                                <input type="text" maxlength="50" name="latitude" id="latitude"
                                       class="form-control"
                                       required readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('app.longitude') }} <span
                                            class="required"> * </span></label>
                                <input type="text" maxlength="50" name="longitude" id="longitude"
                                       class="form-control"
                                       required readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>{{ trans('app.formatted_address') }} <span
                                            class="required"> * </span></label>
                                <input type="text" maxlength="150" name="map_address" id="map_address"
                                       class="form-control"
                                       required readonly>
                            </div>
                        </div>
