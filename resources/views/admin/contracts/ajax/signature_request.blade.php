...
<form role="form" method="POST" action="{{ url(Session::get('guard') . '/contracts/' . $contract->id . '/electronic_signature_request') }}"
      id="idForm"
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <label class="col-md-12">{{ trans('app.token_expiration_date') }} <span
                                class="required"> * </span><small><i>{{ trans('app.date_until_which_the_what_can_be_signed', ["what"    =>  strtolower(trans('app.contract'))]) }}</i></small></label>
                    <div class="form-group">
