<div class="row">
    @if(isset($stats))
        @foreach($stats as $key => $value)
            <div class="@if(count($stats) == 2) col-md-6 @else col-md-3 @endif col-sm-12 col-xs-12">
                <div class="white-box">
                    <h3 class="box-title">
                        <small class="pull-right m-t-10 text-success">
                            ...
                            {{--@endif--}}
                            {{ trans('app.average') }}
                            : {{ $stats[$key]['average_value'] }} {{ Session::get('profile_settings')->profile_billing->default_currency }}
                        </small>
                        {{ trans('app.' . $key) }}
                    </h3>
                    <div class="stats-row">
