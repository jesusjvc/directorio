@extends(Session::get('guard') . '.layouts.app') @section('content')
    ...
    <div class="row">
        @include('admin.dashboard.includes.headline')
        @include('admin.dashboard.includes.sparkline')
        @include('admin.dashboard.includes.piecharts')
        @include('admin.dashboard.includes.upcomingsubscriptions')
        @include('admin.dashboard.includes.appointments')
    </div>
@endsection
@push('head')
