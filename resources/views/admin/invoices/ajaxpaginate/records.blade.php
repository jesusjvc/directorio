                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        if(($class == 'ProfilesController') && ($profile != null)):
                            $createlink = url(Session::get('guard') . '/invoices/create/p' . $profile->id);
                        endif;
                        @endphp
                            ...
                            <table class="table">
                                ...
                                <span class="label label-primary">
                                    {{ trans('app.profile') }}
                                                    ...
                                                    <td class="oneline">
                                                        <a href="{{ url(Session::get('guard') . '/profiles/' . $invoice->profile_customer->id) }}">
                                <span class="btn btn-outline btn-info btn-xs">
                                {{ $invoice->profile_customer->business_name }}
                                </span>
                                                        </a>
                                                    </td>
                                                @endif
                                                ...
                                                <td class="text-right oneline">
                                                    @if(count($invoice->invoice_items) > 0)
                                                        ...
                                                        <a class="postconfirm hand tableicon"
                                                           ...
                                                           data-description="{{  trans('app.do_you_want_to_email_invoice_invoiceno_to_whereto',["invoiceno" => $profile->profile_billing->invoice_number_prefix.$invoice->invoice_no,"whereto" => $invoice->profile_customer->business_name]) }}"
                                                           data-reloaddiv="reload"
                                                           @if($class == 'ProfilesController')
                                                           data-reloadurl="{{ url(Session::get('guard') . '/' . $invoice->profile_customer->id . '/invoices') }}"
                                                           @else
