...
<div id="wrapper">
    ...
    @include(Session::get('guard') . '.layouts.includes.top_navigation')
    @include(Session::get('guard') . '.layouts.includes.main_navigation')
    <div id="page-wrapper">
        <div class="container-fluid">
            @yield('content')
        </div>
        <footer class="footer text-center">
            <div id="qwerty" style="font-size:50px;"></div>2016 - {{ date('Y') }} &copy; {{ Session::get('profile_settings')->business_name }}
        </footer>
    </div>
</div>
<script>
