                            ...
                            <table class="table">
                                ...
                                <span class="label label-primary">
                                    {{ trans('app.profile') }}
                                                    ...
                                                    <td class="oneline">
                                                        <a href="{{ url(Session::get('guard') . '/profiles/' . $payment->profile_customer->id) }}">
                                ...
                                {{ $payment->profile_customer->business_name }}
                                                ...
                                                <td class="text-right oneline">
                                                    @if($payment->payment_transaction != null)
                                                        <a href="{{ url(Session::get('guard') . '/payment_transactions/' . $payment->id) }}"
                                                           title="{{ trans('app.related_transaction') }}"
                                                           class="tableicon" data-toggle="modal"
                                                           data-target="#ajaxmodel"
                                                           data-remote="{{ url(Session::get('guard') . '/payment_transactions/' . $payment->id) }}">
                                                    ...
                                                    @if($payment->status == 1)
                                                        <a class="postconfirm hand tableicon"
                                                           ...
                                                           data-description="{{  trans('app.do_you_want_to_email_payment_payment_no_to_whereto',["payment_no" => $profile->profile_billing->payment_number_prefix.$payment->payment_no,"whereto" => $payment->profile_customer->business_name]) }}"
                                                           data-reloaddiv="reload"
                                                           @if($class == 'ProfilesController')
                                                           data-reloadurl="{{ url(Session::get('guard') . '/' . $payment->profile_customer->id . '/payments') }}"
                                                           @else
