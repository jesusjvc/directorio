            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        ...
                        {{--data-remote="{{ url(Session::get('guard')) }}/{{ $profile->id }}/branches/create">--}}
                        {{--{{ trans('app.register_a_new_branch') }}--}}
                        {{--</span>--}}
                        <a class="btn btn-xs btn-success"
                           href="{{ url(Session::get('guard')) }}/{{ $profile->id }}/branches/create">
                            {{ trans('app.register_a_new_branch') }}
                        </a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-xs fetchajaxpage"
                                               href="{{ url(Session::get('guard') . '/' . $branch->profile_id . '/branches/' . $branch->id) }}">{{ trans('app.view') }}</a>
                                        </td>
                                        <td>
                                            <a class="btn btn-primary btn-xs"
                                               href="{{ url(Session::get('guard') . '/' . $branch->profile_id . '/branches/' . $branch->id . '/edit') }}">{{ trans('app.edit') }}</a>
                                        </td>
                                        <td>
                                            <span class="btn btn-danger btn-xs postconfirm"
                                                  ...
                                                  data-reloadurl="{{ url(Session::get('guard') . '/'.$profile->id.'/branches') }}"
                                                  data-posturl="{{ url(Session::get('guard') . '/'.$profile->id.'/branches/'.$branch->id) }}">{{ trans('app.delete') }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
