@extends(Session::get('guard') . '.layouts.app') @section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <form role="form" method="POST" action="{{ url(Session::get('guard') . '/quotations/create') }}">
                {{ csrf_field() }}
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <span class="btn btn-xs btn-warning" data-toggle="collapse" data-target="#collapse"
                                ...
                                {!! trans('app.notice_current_status_is_currentstatus_click_to_read_more',["currentstatus" => "<i>" . trans('app.new_quotation') . "</i>"]) !!}
                            </span>
                    ...
                    <div class="panel-body">
                        <div class="collapse" id="collapse">
                            <div class="text-muted">{!! trans('descriptions.quotation_status_new') !!}</div>
                            <hr>
                        </div>
                        <div class="row">
                            @if($customer != null)
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="text" class="form-control datepicker-autoclose"
                                                       ...
                                                       name="expiry_date"
                                                       value="{{ date('Y-m-d',strtotime("+" . $profile->profile_billing->default_days_quotation_valid . " days")) }}"
                                                       readonly required>
                                                <span class="input-group-addon"><i class="icon-calender"></i></span>
                                            </div>
                                        </div>
                    ...
                    <div class="panel-footer text-right">
                        <button class="btn btn-primary">{{ trans('app.create_quotation') }}</button>
                    </div>
            </form>
        </div>
    </div>
