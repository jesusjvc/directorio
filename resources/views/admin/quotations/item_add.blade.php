<form role="form" method="POST" action="{{ url(Session::get('guard') . '/quotations/' . $quotation->id . '/add_item') }}" id="idForm"
      reloadiv="reload" reloadurl="{{ url(Session::get('guard') . '/quotations/' . $quotation->id . '/items') }}">
    {{ csrf_field() }}
    <div class="">
        ...
        <div class="col-md-2">
            <label class="oneline">{{ trans('app.item_amount') }} <small>{{ trans('app.excl_tax') }}</small> <span class="required"> * </span></label>
        ...
        <div class="col-md-1 text-center">
            ...
            <a class="fetchajaxpage" href="{{ url(Session::get('guard') . '/quotations/' . $quotation->id . '/items') }}">
