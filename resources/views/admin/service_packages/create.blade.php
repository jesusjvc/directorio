<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">{{ trans('app.register_a_new_subscription_plan') }} </h4>
</div>
<form role="form" method="POST" action="{{ url(Session::get('guard') . '/service_packages') }}" id="idForm"
        ...
        <div class="form-body">
            ...
            <div class="form-group">
                <label>{{ trans('app.description') }} <span
                            class="required"> * </span></label>
                <input type="text" maxlength="150" name="description" class="form-control" required>
            </div>
            <div class="form-group">
                <div class="checkbox">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="number" min="0" max="365" name="expire_in_x_days" value="0" class="form-control"
                           required>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="number" min="0" name="limit_customer_accounts" value="0" class="form-control"
                           required>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="number" min="0" name="limit_professional_accounts" value="0" class="form-control"
                           required>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="number" step="0.01" name="monthly_charge_per_profile" value="0.00" class="form-control"
                           required>
