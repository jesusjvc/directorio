                                        ...
                                        <tr>
                                            ...
                                            @if($class == 'SubscriptionsController')
                                                ...
                                                @elseif($subscription->profile_customer != null)
                                                    ...
                                                    <td>
                                                        <a href="{{ url(Session::get('guard') . '/profiles/' . $subscription->profile_customer->id) }}">
                                                            <span class="btn btn-outline btn-info btn-xs">
                                                            {{ $subscription->profile_customer->business_name }}
                                                            </span>
                                                        </a>
                                                    </td>
                                                @endif
                                            ...
                                            <td class="text-center">
                                                ...
                                                <span class="btn btn-danger btn-xs postconfirm"
                                                      ...
                                                      data-reloadurl="{{ url(Session::get('guard') . '/' . $subscription->profile_customer->id . '/subscriptions') }}"
                                                      @elseif($class == 'CustomersController')
