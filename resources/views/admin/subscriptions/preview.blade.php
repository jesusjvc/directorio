...
@if($profile_customer != null)
    <footer>{!! trans('app.credit_note_credit_note_no_addressed_to_customername',["credit_note_no" => $profile_billing->credit_note_number_prefix . $credit_note->credit_note_no,"customername" => ucwords($profile_customer->business_name)]) !!}
                        ...
                        <table style="{{ $style['pdf-body_inner'] }} {{ $style['pdf-items-fontstyle'] }}" width="100%"
                            ...
                            <tr>
                                <td style="line-height:18px; vertical-align:top;" width="35%">
                                    ...
                                    @if($profile_customer != null)
                                        <p>
                                            <span style="text-transform:uppercase; font-weight:bold;">{{ ucwords($profile_customer->business_name) }}</span>
                                            <span style="text-transform:uppercase; font-weight:normal;"><br><i>#{{ ucwords($profile_customer->account_number) }}</i><br></span>
                                            ...
                                            @endif
                                            @if(($profile_customer->profile_billing->tax_enabled == 1) && (($profile->profile_billing->tax_number != null)))
                                                <br>{{ trans('app.tax_number') }}
                                                #{{ $profile_customer->profile_billing->tax_number }}
                                            @endif
                                        </p>
                                    @else
                                        <p>
