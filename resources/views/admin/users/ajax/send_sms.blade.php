...
@endphp
<div class="reload">
    <form role="form" method="POST" action="{{ url(Session::get('guard') . '/' . $profile->id . '/' . $section . '/' . $user->id . '/send_sms/' . $contactid) }}" id="idForm"
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <a href="{{ url(Session::get('guard') . '/' . $profile->id . '/' . $section) }}" class="fetchajaxpage">
