...
<div class="modalhide">
    ...
    <form role="form" method="POST" action="{{ url(Session::get('guard') . '/' . $profile->id . '/' . $section) }}" id="idForm"
          reloadiv="reload" reloadurl="{{ url(Session::get('guard') . '/' . $profile->id . '/' . $section) }}">
