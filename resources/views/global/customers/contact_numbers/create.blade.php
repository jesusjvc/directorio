<div class="modalhide">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">{{ trans('app.add_a_contact_number') }}
            <br>
            <small>{{ ucwords(trans('app.' . $customer->prefix) . ' ' . $customer->firstname . ' ' . $customer->lastname) }}</small>
        </h4>
    </div>
    <form role="form" method="POST" action="{{ url(Session::get('guard') . '/customer_contact_numbers/' . $customer->id) }}" id="idForm"
