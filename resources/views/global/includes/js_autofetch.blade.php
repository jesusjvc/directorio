<script>
    ...
    function ajax_inbound_sms_messages() {
        ...
        var inbound_messages = $("span.ajax_inbound_sms_messages").load("{{ url('/admin/ajaxdata/inbound_sms_messages') }}", function (response, status, inbound_messages) {
    ...
    function ajax_unrouted_inbound_sms_messages() {
        ...
        var unrouted_inbound_messages = $("span.ajax_unrouted_inbound_sms_messages").load("{{ url('/admin/ajaxdata/unrouted_inbound_sms_messages') }}", function (response, status, unrouted_inbound_messages) {
    ...
    function ajax_system_errors() {
        ...
        var system_errors = $("span.ajax_system_errors").load("{{ url('/admin/ajaxdata/system_errors') }}", function (response, status, system_errors) {
    ...
    function ajax_read_notifications() {
        ...
        var read_notifications = $("span.ajax_read_notifications").load("{{ url('/admin/ajaxdata/read_notifications') }}", function (response, status, system_errors) {
