        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('app.scheduled_call_notifications') }}: {{ $branch->branch_name }}
                    <div class="pull-right">
                        <a href="{{ url(Session::get('guard') . '/scheduled_call_notifications/' . $branch->id . '/create') }}" class="fetchajaxpage">
                ...
                @php
                    $scheduled_call_notifications = $branch->scheduled_call_notifications;
                @endphp
                <div class="panel-body">
                    ...
                    @if(count($scheduled_call_notifications) > 0)
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            @foreach($scheduled_call_notifications as $notification)
                                <tr>
                                    <td class="text-left">
                                    ...
                                    <td>
                                        <a href="{{ url(Session::get('guard') . '/scheduled_call_notifications/' . $branch->id . '/edit/'. $notification->id) }}"
                                           class="fetchajaxpage">
                                    ...
                                    <td>
                                            <span class="hand btn btn-danger btn-xs postconfirm"
                                                  ...
                                                  data-reloadurl="{{ url(Session::get('guard') . '/scheduled_call_notifications/' . $branch->id) }}"
                                                  data-posturl="{{ url(Session::get('guard') . '/scheduled_call_notifications/' . $branch->id . '/delete/'. $notification->id) }}">
                                                            {{ trans('app.delete') }}
                                                        </span>
                                    </td>
                                </tr>
