        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('app.create_a_new_scheduled_text_notification_for_agendaname', ["agendaname"   =>  $branch->branch_name]) }}
                    <div class="pull-right">
                        <a href="{{ url(Session::get('guard') . '/scheduled_text_notifications/' . $branch->id) }}" class="fetchajaxpage">
                ...
                <form role="form" method="POST" action="{{ url(Session::get('guard') . '/scheduled_text_notifications/' . $branch->id) }}"
                      reloadurl="{{ url(Session::get('guard') . '/scheduled_text_notifications/' . $branch->id) }}"
                      id="idForm">
                    {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="7" maxlength="640" name="notification_message" class="form-control"
                                              required></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
