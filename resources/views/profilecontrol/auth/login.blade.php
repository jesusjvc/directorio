...
@section('content')
    <section id="wrapper" class="login-register">
        <div class="login-box login-sidebar">
            <div class="white-box">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/profilecontrol/login') }}">
                    {{ csrf_field() }}
                    <h3 class="text-center">
                        {{ Session::get('profile_settings')->business_name }}
                    <br>
                        <small>
                            {{ trans('app.profile_control_panel') }}
                        </small>
                    </h3>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <a href="{{ url('profilecontrol/password/reset') }}" id="to-recover" class="text-dark pull-right"><i
