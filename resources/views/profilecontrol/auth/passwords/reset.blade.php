...
@section('content')
    <section id="wrapper" class="login-register">
        <div class="login-box">
            <div class="white-box">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/profilecontrol/password/reset') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <a href="{{ url('profilecontrol/login') }}" id="to-recover" class="text-dark pull-right"><i
