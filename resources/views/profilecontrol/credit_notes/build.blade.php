    ...
    <div class="row">
        <div class="col-md-12">
            <form role="form" method="POST"
                  action="{{ url(Session::get('guard') . '/credit_notes/' . $credit_note->id . '/build') }}"
                  class="autosave">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
                                                ...
                                                <select name="tax_configuration_id" class="form-control"
                                                    ...
                                                    @foreach($tax_configurations as $tax_configuration)
                                                        <option value="{{ $tax_configuration->id }}"
                                                                @if($credit_note->tax_configuration_id == $tax_configuration->id) selected @endif>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="description"
                                                   value="{{ $credit_note->description }}"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label>{{ trans('app.amount') }} <span
                                                    class="required"> * </span>@if($profile->profile_billing->tax_enabled == 1)
                                                <small>{{ trans('app.tax_inclusive') }}</small>@endif</label>
                                        <div class="form-group">
                                            <input type="number" step="0.01" min="0" class="form-control"
                                                   name="total_amount" value="{{ $credit_note->total_amount }}"
                                                   required>
                                        </div>
                                    </div>
                                </div>
