<div class="col-md-12 col-lg-12 col-sm-12">
    <div class="white-box">
        <h3 class="box-title">
            {{ trans('app.customer_subscriptions') }}
        </h3>
        <div class="row sales-report">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6 ">
                <h1 class="text-right text-success m-t-20">{{ Auth::guard(Session::get('guard'))->user()->profile->profile_billing->default_currency }} {{ number_format($subscriptiontotal,2) }}</h1>
            </div>
        </div>
            ...
            <table class="table ">
                ...
                @if(count($subscriptions) > 0)
                    @foreach($subscriptions as $subscription)
                        <tr>
                            <td class="txt-oflo">
                                #{{ $profile->profile_billing->subscription_number_prefix }}{{ $subscription->subscription_no }}</td>
                            <td class="txt-oflo">
