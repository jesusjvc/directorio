@extends(Session::get('guard') . '.layouts.app') @section('content')
    ...
    @include(Session::get('guard') . '.payments.ajaxpaginate.records')
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('body').on('click', '.noedit', function (e) {
            ...
            var payment_no = $(e.currentTarget).data("payment_no");
            var payment_status = $(e.currentTarget).data("payment_status");

            swal({
                title: "{{ trans('app.this_payment_can_not_be_edited') }}",
                text: "{{ trans('app.the_status_for_payment') }} " + payment_no + " {{ trans('app.is') }} " + payment_status + " {{ trans('app.and_can_therefore_not_be_edited_or_changed') }}",
                html: true,
                type: "warning",
