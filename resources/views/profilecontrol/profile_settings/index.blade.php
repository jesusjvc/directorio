        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-group wiz-aco" id="accordion" role="tablist"
                    ...
                    <form method="POST" action="{{ url('profilecontrol/profile_settings') }}" enctype="multipart/form-data" id="validation" class="validation">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        ...
                        <div class="panel panel-info">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body">
                                    @include('profilecontrol.profile_settings.profile')
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    @include('profilecontrol.profile_settings.profile_address')
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                <div class="panel-body">
                                    @include('profilecontrol.profile_settings.profile_settings')
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                <div class="panel-body">
                                    @include('profilecontrol.profile_settings.profile_billing_settings')
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                                <div class="panel-body">
                                    @include('profilecontrol.profile_settings.profile_logo')
                                </div>
                            </div>
                        </div>
                    </form>
...
@endpush
@push('javascript')
@include('profilecontrol.profile_settings.js')
