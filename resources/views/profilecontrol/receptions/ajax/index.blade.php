                ...
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <span class="btn btn-xs btn-success" data-toggle="modal" data-target="#ajaxmodel"
                              data-remote="{{ url(Session::get('guard') . '/receptions/create') }}">
                            ...
                            <table class="table">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url(Session::get('guard') . '/receptions/' . $user->id . '/send_mail') }}"
                                               class="fetchajaxpage"
                                        ...
                                        <td>
                                            @if(is_numeric($user->mobile_no))
                                                ...
                                                <a href="{{ url(Session::get('guard') . '/receptions/' . $user->id . '/send_sms') }}"
                                        ...
                                        <span class="btn btn-primary btn-xs" data-toggle="modal"
                                              ...
                                              data-remote="{{ url(Session::get('guard') . '/receptions/'.$user->id.'/edit') }}">{{ trans('app.edit') }}</span>
                                        </td>
                                        <td>
                                            <form role="form" method="POST"
                                                  action="{{ url(Session::get('guard') . '/receptions/'.$user->id) }}"
                                                  id="{{ $user->id }}">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                                                <span class="btn btn-danger btn-xs postconfirm"
                                                      ...
                                                      data-reloadurl="{{ url(Session::get('guard') . '/receptions') }}"
                                                      data-posturl="{{ url(Session::get('guard') . '/receptions/'.$user->id) }}">{{ trans('app.delete') }}
                                                </span>
                                            </form>
                                        </td>
                                    </tr>
