        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('app.build_subscription_subscription_no',["subscription_no" => Auth::guard(Session::get('guard'))->user()->profile->profile_billing->subscription_number_prefix . $subscription->subscription_no]) }}
                ...
                <div class="panel-body">
                    <form role="form" method="POST"
                          action="{{ url(Session::get('guard') . '/subscriptions/' . $subscription->id . '/build') }}"
                          class="autosave">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <select name="interval" class="form-control select2" required>
                                                <option value="daily"
                                                        @if($subscription->interval == "daily") selected @endif>
                                                    {{ trans('app.daily') }}
                                                </option>
                                                <option value="weekly"
                                                        @if($subscription->interval == "weekly") selected @endif>
                                                    {{ trans('app.weekly') }}
                                                </option>
                                                <option value="bimonthly"
                                                        @if($subscription->interval == "bimonthly") selected @endif>
                                                    {{ trans('app.bi_monthly') }}
                                                </option>
                                                <option value="monthly"
                                                        @if($subscription->interval == "monthly") selected @endif>
                                                    {{ trans('app.monthly') }}
                                                </option>
                                                <option value="quarterly"
                                                        @if($subscription->interval == "quarterly") selected @endif>
                                                    {{ trans('app.quarterly') }}
                                                </option>
                                                <option value="biannually"
                                                        @if($subscription->interval == "biannually") selected @endif>
                                                    {{ trans('app.bi_annually') }}
                                                </option>
                                                <option value="annually"
                                                        @if($subscription->interval == "annually") selected @endif>
                                                    {{ trans('app.annually') }}
                                                </option>
                                            </select>
                                            <div class="help-block with-errors"></div>
