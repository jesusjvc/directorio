                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <span class="btn btn-xs btn-info" data-toggle="modal" data-target="#ajaxmodel"
                                              data-remote="{{ url(Session::get('guard') . '/user_contact_numbers/' . $user->id . '/create') }}">
                                        ...
                                        <td>
                                            @if($user->id != Auth::guard(Session::get('guard'))->user()->id)
                                                <form role="form" method="POST"
                                                      action="{{ url(Session::get('guard') . '/users/'.$user->id) }}"
                                                      id="{{ $user->id }}">
                                                    {{ method_field('DELETE') }}
                                                    {{ csrf_field() }}
